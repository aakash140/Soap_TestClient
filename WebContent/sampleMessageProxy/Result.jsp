...
<jsp:useBean id="sampleMessageProxyid" scope="session" class="com.java.soap.MessageProxy" />
<%
...
case 10:
        gotMethod = true;
        com.java.soap.Message getMessage10mtemp = sampleMessageProxyid.getMessage();
...
<%
        ...
        if(getMessage10mtemp!= null){
        String tempreturnp11 = getMessage10mtemp.toString();
        %>
        <%=tempreturnp11%>
        <%
        }}
...
case 13:
        ...
        java.lang.String printMessage13mtemp = sampleMessageProxyid.printMessage(name_1idTemp);
